...
function AgentPerfomance() {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(AgentPerformanceWrapper, { children: (0, jsx_runtime_1.jsxs)(AgentPerformanceDetailWrapper, { children: [(0, jsx_runtime_1.jsxs)(AgentPerformancHeader, { children: [(0, jsx_runtime_1.jsx)(AgentPerformance, { children: "\uC694\uC6D0 \uD37C\uD3EC\uBA3C\uC2A4" }), (0, jsx_runtime_1.jsx)("select", Object.assign({ className: "act" }, { children: (0, jsx_runtime_1.jsx)("option", { children: "\uACBD\uC7C1\uC804" }) }))] }), (0, jsx_runtime_1.jsxs)(AgentPerformanceInfoWrapper, { children: [agentPlayInfos.map((info, index) => {
                            ...
                            }), (0, jsx_runtime_1.jsx)(emotionStorage_1.ToggleButtonWrapper, Object.assign({ onClick: toggleShowMoreAgentInfo }, { children: (0, jsx_runtime_1.jsx)(emotionStorage_1.ToggleButton, { children: showMore ? "닫기" : "더보기" }) }))] })] }) }) }));
}
exports.default = AgentPerfomance;
const AgentPerformanceWrapper = styled_1.default.div `
    width: 330px;
`;
const AgentPerformanceDetailWrapper = styled_1.default.div `
    background-color: #31313c;
    border-radius: 4px;
    margin-top: 10px;
`;
const AgentPerformancHeader = styled_1.default.div `
    display: flex;
    justify-content: space-between;
    padding: 4px 16px;
    height: 29px;
`;
const AgentPerformance = styled_1.default.span `
    font-size: 13px;
    font-weight: bold;
    display: flex;
    ...
    align-items: center;
`;
const AgentPerformanceInfoWrapper = styled_1.default.div `
    display: flex;
...
`;
const AgentPerformanceInfo = styled_1.default.div `
    display: flex;
    flex-basis: 100%;
    border-bottom: 1px solid #1C1C1F;
    padding: 10px 10px;
`;
const AgentPerformanceInfoAgentImageWrapper = styled_1.default.div `
    flex-basis: 10%;
    display: flex;
    justify-content: center;
    align-items: center;
    padding-right: 10px;
`;
const AgentPerformanceInfoAgent = styled_1.default.div `
    flex-basis: 40%;
    display: flex;
    flex-direction: column;
`;
const AgentPerformanceAgent = styled_1.default.span `
    font-size: 11px;
    font-weight: bold;
`;
const AgentPerformanceAvgscore = styled_1.default.span `
    font-size: 11px;
    color: #7b7a8e;
`;
const AgentPerformanceInfoRecord = styled_1.default.div `
    flex-basis: 30%;
    display: flex;
    flex-direction: column;
`;
const AgentPerformanceRecord = styled_1.default.span `
    font-size: 11px;
    color: #9897a8;
    font-weight: bold;
`;
const AgentPerformanceKda = styled_1.default.span `
    font-size: 11px;
    color: #7b7a8e;
`;
const AgentPerformanceInfoWinratio = styled_1.default.div `
    flex-basis: 20%;
    display: flex;
    flex-direction: column;
`;
const AgentPerformanceWinratio = styled_1.default.span `
    font-size: 11px;
    color: #e05271;
    font-weight: bold;
    text-align: right;
`;
const AgentPerformanceMatchcount = styled_1.default.span `
    font-size: 11px;
    text-align: right;
`;
