...
function TopWeapon() {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(TopWeaponStatsWrapper, { children: (0, jsx_runtime_1.jsxs)(TopWeaponStatsDetailWrapper, { children: [(0, jsx_runtime_1.jsxs)(TopWeaponStatsHeader, { children: [(0, jsx_runtime_1.jsx)(TopWeaponLabel, { children: "Top \uBB34\uAE30" }), (0, jsx_runtime_1.jsx)("select", Object.assign({ className: "act" }, { children: (0, jsx_runtime_1.jsx)("option", { children: "\uACBD\uC7C1\uC804" }) }))] }), (0, jsx_runtime_1.jsxs)(TopWeaponInfoWrapper, { children: [usedWeaponInfos.map((info, index) => {
                            ...
                            }), (0, jsx_runtime_1.jsx)(emotionStorage_1.ToggleButtonWrapper, Object.assign({ onClick: toggleShowMoreUsedWeaponInfo }, { children: (0, jsx_runtime_1.jsx)(emotionStorage_1.ToggleButton, { children: showMore ? "닫기" : "더보기" }) }))] })] }) }) }));
}
exports.default = TopWeapon;
const TopWeaponStatsWrapper = styled_1.default.div `
    width: 330px;
`;
const TopWeaponStatsDetailWrapper = styled_1.default.div `
    background-color: #31313c;
    border-radius: 4px;
    margin-top: 10px;
`;
const TopWeaponStatsHeader = styled_1.default.div `
    display: flex;
    justify-content: space-between;
    padding: 4px 16px;
    height: 29px;
`;
const TopWeaponLabel = styled_1.default.span `
    font-size: 14px;
    font-weight: bold;
    display: flex;
    ...
    align-items: center;
`;
const TopWeaponInfoWrapper = styled_1.default.div `
    display: flex;
...
`;
const TopweaponInfo = styled_1.default.div `
    display: flex;
    flex-basis: 100%;
    border-bottom: 1px solid #1C1C1F;
    padding: 10px 10px;
`;
const TopWeaponInfoWeaponImageWrapper = styled_1.default.div `
    flex-basis: 10%;
    display: flex;
    justify-content: center;
    align-items: center;
...
`;
const TopWeaponInfoWeapon = styled_1.default.div `
    flex-basis: 40%;
    display: flex;
    flex-direction: column;
`;
const TopWeaponAgent = styled_1.default.span `
    font-size: 11px;
    font-weight: bold;
`;
const TopWeaponAvgscore = styled_1.default.span `
    font-size: 11px;
    color: #7b7a8e;
`;
const TopWeaponInfoRecord = styled_1.default.div `
    flex-basis: 30%;
    display: flex;
    flex-direction: column;
`;
const TopWeaponRecord = styled_1.default.span `
    font-size: 11px;
    color: #9897a8;
    font-weight: bold;
`;
