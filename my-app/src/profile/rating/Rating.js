...
const RatingLabel = styled_1.default.span `
    ...
    align-items: center;
`;
const Act = styled_1.default.select `
    width: 100px;
`;
const RankInfoWrapper = styled_1.default.div `
    display: flex;
    padding: 16px 16px;
    margin: 2px 0 2px 0;
    border-top: 1px solid #1C1C1F;
`;
const RankImageWrapper = styled_1.default.div `
    width: 75px;
    height: 72px;
    margin-right: 20px;
    display: flex;
...
//     height: 50px;
// `
const RankStatsWrapper = styled_1.default.div `    
    display: flex;
    flex-direction: column;
`;
const Rank = styled_1.default.span `
    font-weight: bold;
    font-size: 18px;
    margin-bottom: 2px;
`;
const Kda = styled_1.default.span `
    font-size: 11px;
    color: #7b7a8e;
    font-weight: bold;
    margin-bottom: 2px;
`;
const WinLose = styled_1.default.span `
    font-size: 11px;
    color: #7b7a8e;
`;
const RecordWrapper = styled_1.default.div `
    display: flex;
    flex-wrap: wrap;
    padding: 10px 16px;
    margin: 2px 0 2px 0;
`;
const RecordDPRWrapper = styled_1.default.div `
    display: flex;
    justify-content: center;
    flex-direction: column;
    flex-basis: 33%;
    position: relative;
`;
const DprLabel = styled_1.default.span `
    font-size: 11px;
    color: #7b7a8e;
    text-align: center;
`;
const Dpr = styled_1.default.span `
    text-align: center;
`;
const RecordDescription = styled_1.default.div `
    text-align: center;
    border-top: 1px solid #1C1C1F;
    color: #7b7a8e;
    padding-top: 3px;
    font-size: 12px;
`;
const RecordKDWrapper = styled_1.default.div `
    display: flex;
    justify-content: center;
    flex-direction: column;
    flex-basis: 33%;
...
`;
const KDRatioLabel = styled_1.default.span `
    font-size: 11px;
    color: #7b7a8e;
    text-align: center;
`;
const KDRatio = styled_1.default.span `
    text-align: center;
`;
const RecordWinRatioWrapper = styled_1.default.div `    
    display: flex;
    justify-content: center;
    flex-direction: column;
    flex-basis: 33%;
...
`;
const WinRatioLabel = styled_1.default.span `
    font-size: 11px;
    color: #7b7a8e;
    text-align: center;
`;
const WinRatio = styled_1.default.span `
    text-align: center;
`;
const RecordSPRWrapper = styled_1.default.div `
    display: flex;
    justify-content: center;
    flex-direction: column;
    flex-basis: 33%;
    position: relative;
`;
const SPRLabel = styled_1.default.span `
    font-size: 11px;
    color: #7b7a8e;
    text-align: center;
`;
const SPR = styled_1.default.span `
    text-align: center;
`;
const DetailRecordWrapper = styled_1.default.div `
    display: flex;
    flex-wrap: wrap;
    padding: 10px 16px;
    margin: 2px 0 2px 0;
    ...
    background-color: #282830;
`;
const DetailRecordKillWrapper = styled_1.default.div `    
    flex-basis: 50%;
    margin-bottom: 8px;
`;
const Kill = styled_1.default.span `
    display: block;
    font-size: 11px;
    color: #7b7a8e;
`;
const KillCount = styled_1.default.span `
    display: block;
    font-size: 12px;
    color: white;
    margin-top: 1px;
`;
const Death = styled_1.default.span `
    display: block;
    font-size: 11px;
    color: #7b7a8e;
`;
const DeathCount = styled_1.default.span `
    display: block;
    font-size: 12px;
    color: white;
    margin-top: 1px;
`;
const Assists = styled_1.default.span `
    display: block;
    font-size: 11px;
    color: #7b7a8e;
`;
const AssistsCount = styled_1.default.span `
    display: block;
    font-size: 12px;
    color: white;
    margin-top: 1px;
`;
const HeadShot = styled_1.default.span `
    display: block;
    font-size: 11px;
    color: #7b7a8e;
`;
const HeadShotCount = styled_1.default.span `
    display: block;
    font-size: 12px;
    color: white;
    margin-top: 1px;
`;
const BodyShot = styled_1.default.span `
    display: block;
    font-size: 11px;
    color: #7b7a8e;
`;
const BodyShotCount = styled_1.default.span `
    display: block;
    font-size: 12px;
    color: white;
    margin-top: 1px;
`;
const LegShot = styled_1.default.span `
    display: block;
    font-size: 11px;
    color: #7b7a8e;
`;
const LegShotCount = styled_1.default.span `
    display: block;
    font-size: 12px;
    color: white;
    margin-top: 1px;
`;
const MostKillMatch = styled_1.default.span `
    display: block;
    font-size: 11px;
    color: #7b7a8e;
`;
const MostKillMatchCount = styled_1.default.span `
    display: block;
    font-size: 12px;
    color: white;
    margin-top: 1px;
`;
const PlayTime = styled_1.default.span `
    display: block;
    font-size: 11px;
    color: #7b7a8e;
`;
const PlayTimeCount = styled_1.default.span `
    display: block;
    font-size: 12px;
    color: white;
    margin-top: 1px;
`;
const DetailRecordDeathWrapper = styled_1.default.div `
    flex-basis: 50%;
    margin-bottom: 8px;
`;
const DetailRecordAssistsWrapper = styled_1.default.div `
    flex-basis: 50%;
    margin-bottom: 8px;
`;
const DetailRecordHeadShotWrapper = styled_1.default.div `
    flex-basis: 50%;
    margin-bottom: 8px;
`;
const DetailRecordBodyShotWrapper = styled_1.default.div `
    flex-basis: 50%;
    margin-bottom: 8px;
`;
const DetailRecordLegShotWrapper = styled_1.default.div `
    flex-basis: 50%;
    margin-bottom: 8px;
`;
const DetailRecordMostKillMatchWrapper = styled_1.default.div `
    flex-basis: 50%;
    margin-bottom: 8px;
`;
const DetailRecordPlayTimeWrapper = styled_1.default.div `
    flex-basis: 50%;
    margin-bottom: 8px;
`;
